...
class _RecordingScreenState extends State<RecordingScreen> {
  ...
  void _initializeRecording() {
    ...
    _sensorSubscription = sensorService.sampleStream.listen((sample) {
      if (mounted && _isRecording) {
        setState(() {
          _currentLux = sample.ambientLux;
          // Simple CS estimate for live display
          final melanopicRatio =
              CircadianConstants.melanopicRatios[_selectedLightType] ?? 0.6;
          final melanopicLux = _currentLux * melanopicRatio;
